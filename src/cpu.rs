...
/// Implements NES 8-bit CPU utilizing 6502 instructions. 
impl CPU {
    pub fn new() -> Self {
        CPU {
            register_a: 0,
    ...
    /// Function handling 6502 CPU architecture's different addressing modes.
    ...
    /* 
    Funtions managing pop/push for the memory stack 
    */
    ...
    /*
    Functions handling direct setting of registers/flags. 
    */
    ...
    fn register_a_add(&mut self, data: u8) {
    ...
    /*
    Functions handling opcode logic.
    */
    fn adc(&mut self, mode: &AddressingMode) {
        let addr = self.get_operand_address(&mode);
        let data = self.mem_read(addr);
        self.register_a_add(data);
    }
    ...
    fn sbc(&mut self, mode: &AddressingMode) {
        let addr = self.get_operand_address(&mode);
        let data = self.mem_read(addr);
        self.register_a_add(((data as i8).wrapping_neg().wrapping_sub(1)) as u8);
    }
    ...
    /* 
    Functions handling flow of logic.
    */
    ...
    /*
    Functions dealing with NES states: reset, load, run, load and run.
    */
        ...
        loop {
            ...
            match code {
                ...
                */
                ...
                // LSR a - Left Shift Right Accumulator. 
                0x4a => self.lsr_accumulator(),

                /*
                LSR - Left Shift Right.
                */
                0x46 | 0x56 | 0x4e | 0x5e => {
